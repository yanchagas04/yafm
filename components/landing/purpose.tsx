...
export default function Purpose() {
  ...
  return (
    <section className="w-full max-w-6xl p-6 flex flex-col items-center text-center">
      <div className="max-w-3xl">
        <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight bg-linear-to-r from-emerald-400 to-teal-300 bg-clip-text text-transparent mb-6 text-justify">
          O que é o YAFM?
        </h2>
